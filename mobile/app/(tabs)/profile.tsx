...
export default function ProfileScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      {/* Screen Title */}
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingTop: 16, paddingBottom: 8, backgroundColor: colors.background, gap: 12 }}>
        <TouchableOpacity onPress={() => router.canGoBack() ? router.back() : router.navigate('/(tabs)')} style={{ padding: 4, marginLeft: -4 }}>
          <Ionicons name="arrow-back" size={24} color={colors.textPrimary} />
        </TouchableOpacity>
        <Text style={{ fontSize: 26, fontWeight: '900', color: colors.textPrimary, letterSpacing: -0.5 }}>Profile</Text>
      </View>
